                                            ...
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        ...
                                                        alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('frontend/assets/images/product-image/10_2.jpg')}}"
                                                        alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/10_1.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/10_1.jpg')}}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#41d49c;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/10_2.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/10_2.jpg')}}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#fc8484;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/10_3.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/10_3.jpg')}}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#db94f7;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/10_4.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/10_4.jpg')}}"
                                                                data-tooltip="Sky Blue"><span
                                            ...
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        ...
                                                        alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('frontend/assets/images/product-image/14_2.jpg')}}"
                                                        alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <a href="#" class="quickview" data-link-action="quickview"
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/14_1.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/14_1.jpg')}}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#bb8641;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/14_2.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/14_2.jpg')}}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#5dd677;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/14_3.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/14_3.jpg')}}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#32ffdd;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/14_4.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/14_4.jpg')}}"
                                                                data-tooltip="Sky Blue"><span
                                            ...
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        ...
                                                        alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('frontend/assets/images/product-image/15_2.jpg')}}"
                                                        alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/15_1.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/15_1.jpg')}}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#ffacfb;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/15_2.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/15_2.jpg')}}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#90dfff;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/15_3.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/15_3.jpg')}}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#c6ff4a;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/15_4.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/15_4.jpg')}}"
                                                                data-tooltip="Sky Blue"><span
                                            ...
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        ...
                                                        alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('frontend/assets/images/product-image/16_2.jpg')}}"
                                                        alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/16_1.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/16_1.jpg')}}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#6ee9ff;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/16_2.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/16_2.jpg')}}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#eb99ff;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/16_3.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/16_3.jpg')}}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#ff6464;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/16_4.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/16_4.jpg')}}"
                                                                data-tooltip="Sky Blue"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('frontend/assets/images/product-image/17_1.jpg')}}"
                                                        alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('frontend/assets/images/product-image/17_2.jpg')}}"
                                                        alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/17_1.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/17_1.jpg')}}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#8ad2fc;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/17_2.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/17_2.jpg')}}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#ff8ef6;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/17_3.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/17_3.jpg')}}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#ffbe31;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('frontend/assets/images/product-image/17_4.jpg')}}"
                                                                data-src-hover="{{asset('frontend/assets/images/product-image/17_4.jpg')}}"
                                                                data-tooltip="Sky Blue"><span
                ...
                <div class="ec-banner-block ec-banner-block-2">
                    <div class="row">
                        ...
                        <div class="banner-block col-lg-6 col-md-12" data-animation="slideInLeft">
                            <div class="bnr-overlay">
                                <img src="{{asset('frontend/assets/images/banner/3.jpg')}}" alt="" />
                                <div class="banner-text">
                    ...
                    <ul class="ec-cat-tab-nav nav">
                        <li class="cat-item"><a class="cat-link active" data-bs-toggle="tab" href="#tab-cat-1">
                                <div class="cat-icons"><img class="cat-icon"
                                        ...
                                        class="cat-icon-hover" src="{{asset('frontend/assets/images/icons/cat_1_1.png')}}"
                                        alt="cat-icon"></div>
                        ...
                        <li class="cat-item"><a class="cat-link" data-bs-toggle="tab" href="#tab-cat-2">
                                <div class="cat-icons"><img class="cat-icon"
                                        ...
                                        class="cat-icon-hover" src="{{asset('frontend/assets/images/icons/cat_2_1.png')}}"
                                        alt="cat-icon"></div>
                        ...
                        <li class="cat-item"><a class="cat-link" data-bs-toggle="tab" href="#tab-cat-3">
                                <div class="cat-icons"><img class="cat-icon"
                                        ...
                                        class="cat-icon-hover" src="{{asset('frontend/assets/images/icons/cat_3_1.png')}}"
                                        alt="cat-icon"></div>
                        ...
                        <li class="cat-item"><a class="cat-link" data-bs-toggle="tab" href="#tab-cat-4">
                                <div class="cat-icons"><img class="cat-icon"
                                        src="{{asset('frontend/assets/images/icons/cat_4.png')}}" alt="cat-icon"><img
                                        class="cat-icon-hover" src="{{asset('frontend/assets/images/icons/cat_4_1.png')}}"
                                        alt="cat-icon"></div>
            ...
            <div class="row margin-minus-t-15 margin-minus-b-15">
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ec_ven_content" data-animation="zoomIn">
                    <div class="ec-vendor-card">
                        <div class="ec-vendor-detail">
                            <div class="ec-vendor-avtar">
                                <img src="{{asset('frontend/assets/images/vendor/5.jpg')}}" alt="vendor img">
                            </div>
                            <div class="ec-vendor-info">
            ...
            <div class="row justify-content-end">
                <div class="col-xl-6 col-lg-7 col-md-7 col-sm-7 align-self-center ec-offer-content">
                    ...
                    <span class="ec-offer-img" data-animation="zoomIn"><img
                            src="{{asset('frontend/assets/images/offer-image/1.png')}}" alt="offer image" /></span>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image" src="{{asset('frontend/assets/images/product-image/9_1.jpg')}}"
                                        alt="Product" />
                                    <img class="hover-image" src="{{asset('frontend/assets/images/product-image/9_2.jpg')}}"
                                        alt="Product" />
                                </a>
                                <span class="flags">
                                    <span class="sale">Sale</span>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image" src="{{asset('frontend/assets/images/product-image/11_1.jpg')}}"
                                        alt="Product" />
                                    <img class="hover-image"
                                        src="{{asset('frontend/assets/images/product-image/11_2.jpg')}}" alt="Product" />
                                </a>
                                <span class="flags">
                                    <span class="new">New</span>
                                </span>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image" src="{{asset('frontend/assets/images/product-image/12_1.jpg')}}"
                                        alt="Product" />
                                    <img class="hover-image"
                                        src="{{asset('frontend/assets/images/product-image/12_2.jpg')}}" alt="Product" />
                                </a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image" src="{{asset('frontend/assets/images/product-image/13_1.jpg')}}"
                                        alt="Product" />
                                    <img class="hover-image"
                                        src="{{asset('frontend/assets/images/product-image/13_2.jpg')}}" alt="Product" />
                                </a>
                                <a href="#" class="quickview" data-link-action="quickview" title="Quick view"
                                    data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><i
                                        class="fi-rr-eye"></i></a>
                ...
                <div class="ec-test-outer">
                    <ul id="ec-testimonial-slider">
                        <li class="ec-test-item">
                            ...
                            <div class="ec-test-inner">
                                <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                        src="{{asset('frontend/assets/images/testimonial/1.jpg')}}" /></div>
                        ...
                        <li class="ec-test-item ">
                            ...
                            <div class="ec-test-inner">
                                <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                        src="{{asset('frontend/assets/images/testimonial/2.jpg')}}" /></div>
                                <div class="ec-test-content">
                                    <div class="ec-test-desc">Lorem Ipsum is simply dummy text of the printing and
                                        typesetting industry. Lorem Ipsum has been the industry's standard dummy text
                                        ever since the 1500s, when an unknown printer took a galley of type and
                        ...
                        <li class="ec-test-item">
                            ...
                            <div class="ec-test-inner">
                                <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                        src="{{asset('frontend/assets/images/testimonial/3.jpg')}}" /></div>
                                <div class="ec-test-content">
                                    <div class="ec-test-desc">Lorem Ipsum is simply dummy text of the printing and
                                        typesetting industry. Lorem Ipsum has been the industry's standard dummy text
                                        ever since the 1500s, when an unknown printer took a galley of type and
                ...
                <div class="container" data-animation="fadeIn">
                    <div class="insta-auto">
                        ...
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img
                                        src="{{asset('frontend/assets/images/instragram-image/1.jpg')}}" alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img
                                        src="{{asset('frontend/assets/images/instragram-image/2.jpg')}}" alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img
                                        src="{{asset('frontend/assets/images/instragram-image/3.jpg')}}" alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img
                                        src="{{asset('frontend/assets/images/instragram-image/4.jpg')}}" alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img
                                        src="{{asset('frontend/assets/images/instragram-image/5.jpg')}}" alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img
                                        src="{{asset('frontend/assets/images/instragram-image/6.jpg')}}" alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img
                                        src="{{asset('frontend/assets/images/instragram-image/7.jpg')}}" alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                    </div>
